/* Archivo:    omp_odd_even1.c
 *
 * Proposito: Usar el odd even transposition sort para ordenar una lista de enteros
 *
 * Compilar: gcc -g -Wall -fopenmp -o omp_odd_even1 omp_odd_even1.c
 * Usar:   ./omp_odd_even1 <thread count> <n> <g|i>
 ...
 * 2.  Esta version bifurca y une thread_count en cada iteracion
...
/*-----------------------------------------------------------------
 * Funcion:  Usage
 * Proposito:   Resumen de como correr el programa
 */
void Usage(char* prog_name) {
